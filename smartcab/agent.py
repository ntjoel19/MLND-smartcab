...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        for outer_key, inner_dict in state_actions.items():
	    	if state_actions[outer_key] > maxQ:
        		maxQ = state_actions[outer_key]
        return maxQ 
    ...
    def choose_action(self, state):
        ...
        if self.learning == False:
			...
			if random.random() < self.epsilon: 
				action_list2 = []
				for outer_key in state_actions:
				    if state_actions[outer_key] is None:
				        action_list2.append(outer_key)
				if action_list2:
